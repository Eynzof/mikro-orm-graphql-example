...
export class Migration20221011143014 extends Migration {
    ...
    async down(): Promise<void> {
        ...
        this.addSql(
            'alter table "post" alter column "created_at" set default \'2022-10-11 14:21:43.480864+00\';',
        );
        this.addSql(
            'alter table "post" alter column "updated_at" type timestamptz using ("updated_at"::timestamptz);',
        );
        this.addSql(
            'alter table "post" alter column "updated_at" set default \'2022-10-11 14:21:43.480864+00\';',
        );
    }
}
